...
class Elevator:
    def __init__(self, building: Building) -> None:
        ...
        self.building_floors: int = self.building.floors
        self.next_passenger: int = 0
        self.max_floor: int = 0
        self.min_floor: int = 0
        self.current_floor: int = 0
        self.has_button_up: bool = True
    ...
    def display(
        ...
        emoji_string = "  ".join(
            [
                ...
                for p in self.elev_passengers
                if not (
                    p.arrival_floor == 1 and p.floor_num == self.current_floor
                )
            ]
        )
        ...
        if previous_floor and previous_floor.floor_num < self.current_floor:
        ...
        if next_floor and self.current_floor != 1:
            print(f"{fins}{dashes_string}")
            print(
    ...
    def display_floors_passenegers(self, floors: List[Floor]):
        print("*" * 20)
        ...
        for floor in floors:
            print(floor, " : ", end=" ")
            [print(p, end=" | ") for p in floor.passengers]
            print()
